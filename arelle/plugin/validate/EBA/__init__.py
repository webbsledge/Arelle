...
def validateFacts(val, factsToCheck):
    ...
    for cntx in contextData.contextsWithSegments:
    ...
    for cntx in contextData.contextsWithImproperContent:
    ...
    for cntx in contextData.contextsWithPeriodTime | contextData.contextsWithPeriodTimeZone:
