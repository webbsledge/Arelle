...
from arelle.utils.validate.Document import checkInlineDocumentEncoding
...
def rule_charsets(
    ...
    """
    invalidEncodings = checkInlineDocumentEncoding(val, ['utf-8', 'utf-8-sig'], STANDARD_TAXONOMY_URL_PREFIXES)
